set :user, 'readability'
set :application, 'readability'

set :repo_url, 'git@github.com:kssamoylenko/bdreadability.git'
set :branch, ENV["REVISION"] || "master"

set :default_env, {
  'PATH' => '/home/readability/.gem/ruby/2.3.0/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games'
}
